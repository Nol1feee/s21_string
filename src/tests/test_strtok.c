...
//   char delim[] = "\0";
//   char *one = s21_strtok(s21_NULL, delim);
//   char *two = strtok(s21_NULL, delim);
//   ck_assert_pstr_eq(one, two);
// }
// END_TEST
...
START_TEST(s21_strtok_ten) {
  char one_str[][30] = {"wow, are, you, crazy?", "kek \0 ckeck",
                        "NULL, poka, cheb ' ' ", "poke chek"};
  char two_str[][30] = {"wow, are, you, crazy?", "kek \0 ckeck",
                        "NULL, poka,  cheb ' ' ", "poke chek"};
