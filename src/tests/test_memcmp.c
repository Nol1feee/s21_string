...
START_TEST(s21_memcmp_five) {
  ...
  ck_assert_int_eq(s21_memcmp(temp, temp_two, (10 * 5) / 2),
                   memcmp(temp, temp_two, (10 * 5) / 2));
}
END_TEST
...
START_TEST(s21_memcmp_seven) {
  ...
  ck_assert_int_eq(s21_memcmp(temp, temp_two, 111 - 107),
                   memcmp(temp, temp_two, 111 - 107));
}
END_TEST
