...
START_TEST(sscanf_EOF1) {
  ...
  int s21 = s21_sscanf(str, fstr, &a1);
  int standard = sscanf(str, fstr, &a2);
  ck_assert_int_eq(s21, standard);
}
END_TEST
...
END_TEST
 ...
 START_TEST(sscanf_fail6) {
   ...
   int s21 = s21_sscanf(str, fstr, &a1, &a3, &a5);
   int standard = sscanf(str, fstr, &a2, &a4, &a6);
   ck_assert_int_eq(s21, standard);
 }
 END_TEST
...
END_TEST
 ...
 START_TEST(sscanf_format_c1) {
   ...
   int standard = sscanf(str, fstr, &a2, &b2, &c2, &d2);
...
START_TEST(sscanf_format_efg6) {
  float a1 = 0, a2 = 0, b1 = 0, b2 = 0;
  long double c1 = 0, c2 = 0, d1 = 0, d2 = 0;
  int s21 = 0, standard = 0;
  const char str[] =
      "\n \tt1452.5e10 \t\n 163829463 .61553814e15 \t\n  -516173.1469e5";
  const char *fstr = "%7e %*g %LG %Lf";

  s21 = s21_sscanf(str, fstr, &a1, &b1, &c1, &d1);
  standard = sscanf(str, fstr, &a2, &b2, &c2, &d2);
...
START_TEST(sscanf_format_s1) {
  ...
  int s21 = s21_sscanf(str, fstr, s1, s2, &n1, s3);
  int standard = sscanf(str, fstr, s5, s6, &n2, s7);
...
START_TEST(sscanf_format_s3) {
  ...
  int16_t standard = sscanf(str, fstr, s5, s6, s7, s8);
...
START_TEST(sscanf_n1) {
  ...
  int s21 = s21_sscanf(str, fstr, &a1, &a3, &n1);
  int standard = sscanf(str, fstr, &a2, &a4, &n2);
...
START_TEST(sscanf_n2) {
  ...
  int32_t s21 = s21_sscanf(str, fstr, &a1, &b1, &c1, &n1);
  int32_t standard = sscanf(str, fstr, &a2, &b2, &c2, &n2);
...
START_TEST(sscanf_n3) {
  ...
  const char *fstr = "%%%%%d%%%d";
  int s21 = s21_sscanf(str, fstr, &a1, &b1);
  int standard = sscanf(str, fstr, &a2, &b2);
