...
START_TEST(s21_strncmp_one) {
  char temp_one[50] = "1";
  char temp_two[50] = "1";
  ck_assert_int_eq(strncmp(temp_one, temp_two, 1),
                   s21_strncmp(temp_one, temp_two, 1));
}
END_TEST
...
START_TEST(s21_strncmp_two) {
  char temp_one[50] = "";
  char temp_two[50] = "";
  ck_assert_int_eq(strncmp(temp_one, temp_two, 50),
                   s21_strncmp(temp_one, temp_two, 50));
}
END_TEST
...
START_TEST(s21_strncmp_three) {
  char temp_one[50] = " ";
  char temp_two[50] = " ";
  ck_assert_int_eq(strncmp(temp_one, temp_two, -5 + 10),
                   s21_strncmp(temp_one, temp_two, -5 + 10));
}
END_TEST
...
START_TEST(s21_strncmp_four) {
  ...
  ck_assert_int_eq(strncmp(temp_one, temp_two, 4),
                   s21_strncmp(temp_one, temp_two, 4));
}
END_TEST
...
START_TEST(s21_strncmp_six) {
  ...
  ck_assert_int_eq(strncmp(temp_one, temp_two, 11),
                   s21_strncmp(temp_one, temp_two, 11));
}
END_TEST
...
START_TEST(s21_strncmp_eight) {
  ...
  ck_assert_int_eq(strncmp(temp_one, temp_two, 0),
                   s21_strncmp(temp_one, temp_two, 0));
}
END_TEST
