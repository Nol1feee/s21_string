...
START_TEST(s21_strncpy_one) {
  char temp_one[50] = "1";
  char temp_two[50] = "1";
  ck_assert_pstr_eq(strncpy(temp_one, temp_two, 20),
                    s21_strncpy(temp_one, temp_two, 20));
}
END_TEST
...
START_TEST(s21_strncpy_two) {
  char temp_one[50] = "";
  char temp_two[50] = "";
  ck_assert_pstr_eq(strncpy(temp_one, temp_two, 10),
                    s21_strncpy(temp_one, temp_two, 10));
}
END_TEST
...
START_TEST(s21_strncpy_three) {
  char temp_one[50] = " ";
  char temp_two[50] = " ";
  ck_assert_pstr_eq(strncpy(temp_one, temp_two, 0),
                    s21_strncpy(temp_one, temp_two, 0));
}
END_TEST
...
START_TEST(s21_strncpy_four) {
  ...
  ck_assert_pstr_eq(strncpy(temp_one, temp_two, 50),
                    s21_strncpy(temp_one, temp_two, 50));
}
END_TEST
...
START_TEST(s21_strncpy_five) {
  ...
  ck_assert_pstr_eq(strncpy(temp_one, temp_two, 14),
                    s21_strncpy(temp_one, temp_two, 14));
}
END_TEST
...
START_TEST(s21_strncpy_seven) {
  char temp_one[] = {"   "};
  char temp_two[] = {"   "};
  ck_assert_pstr_eq(strncpy(temp_one, temp_two, 1),
                    s21_strncpy(temp_one, temp_two, 1));
}
END_TEST
