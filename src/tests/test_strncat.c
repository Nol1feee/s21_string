...
START_TEST(s21_strncat_five) {
    ...
    const char *res_s21_strncat = s21_strncat(temp_one, "/////04908r9i-ripekwo;fllm\0\0", 10000000);
    const char *res_orig_strncat = strncat(temp_two, "/////04908r9i-ripekwo;fllm\0\0", 10000000);
